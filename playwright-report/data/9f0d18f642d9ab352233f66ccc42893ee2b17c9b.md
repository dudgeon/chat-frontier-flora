...
- Name: Authentication Flow >> Initial App State >> should load the app and show authentication UI
- Location: /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/e2e/auth-flow.spec.ts:24:9
...
Expected pattern: /Chat Frontier Flora/
Received string:  "web"
Call log:
  - expect.toHaveTitle with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="en">…</html>
      - unexpected value "web"

    at /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/e2e/auth-flow.spec.ts:26:26
```

# Page snapshot

```yaml
- text: Chat Frontier Flora Authentication Demo Create Account Email
...
- textbox "Enter your display name"
- text: I agree to the Terms of Service and Privacy Policy Sign Up
```
...
>  26 |       await expect(page).toHaveTitle(/Chat Frontier Flora/);
   ...
   71 |       await expect(page).toHaveURL(/dashboard|profile|home/, { timeout: 10000 });
   72 |     });
   73 |
