...
- Name: Authentication Flow >> Visual Regression >> should match sign up form visual snapshot
- Location: /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/e2e/archived/auth-flow.spec.ts:259:9
...
Error: expect(page).toHaveScreenshot(expected)
  ...
  11857 pixels (ratio 0.05 of all image pixels) are different.

Expected: /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/e2e/archived/auth-flow.spec.ts-snapshots/sign-up-form-Mobile-Chrome-darwin.png
Received: /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/test-results/archived-auth-flow-Authent-ab08d-ign-up-form-visual-snapshot-Mobile-Chrome/sign-up-form-actual.png
    Diff: /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/test-results/archived-auth-flow-Authent-ab08d-ign-up-form-visual-snapshot-Mobile-Chrome/sign-up-form-diff.png

Call log:
  - expect.toHaveScreenshot(sign-up-form.png) with timeout 5000ms
  ...
  - 11857 pixels (ratio 0.05 of all image pixels) are different.
    ...
    at /Users/geoffreydudgeon/Documents/Cursor Projects/chat-frontier-flora/e2e/archived/auth-flow.spec.ts:270:26
```
